...
const fields = [
  ...
  ['tracking', 'meta_pixel_id', DEFAULT_META_PIXEL_ID, 'Primary Meta Pixel ID for direct browser tracking.'],
  ['tracking', 'additional_meta_pixel_ids', '', 'Optional: extra Meta Pixel IDs, comma separated.'],
