...
const slots: Slot[] = [
  ...
  { id: 'topv5', sectionKey: 'showcase_videos', group: 'Top Reel Video Slider', label: 'Top Video 5', title: 'Viral Hook Reel', description: 'Landing page ke upar wale reel card.', type: 'video', width: 1080, height: 1920, sortOrder: 5 },
  { id: 'topv6', sectionKey: 'showcase_videos', group: 'Top Reel Video Slider', label: 'Top Video 6', title: 'Offer Promo Reel', description: 'Landing page ke upar wale reel card.', type: 'video', width: 1080, height: 1920, sortOrder: 6 },
  { id: 'topv7', sectionKey: 'showcase_videos', group: 'Top Reel Video Slider', label: 'Top Video 7', title: 'AI Avatar Reel', description: 'Landing page ke upar wale reel card.', type: 'video', width: 1080, height: 1920, sortOrder: 7 },
  { id: 'topv8', sectionKey: 'showcase_videos', group: 'Top Reel Video Slider', label: 'Top Video 8', title: 'Faceless Shorts Reel', description: 'Landing page ke upar wale reel card.', type: 'video', width: 1080, height: 1920, sortOrder: 8 },
